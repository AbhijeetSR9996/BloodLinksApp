...
const Profile = () => {
    ...
    const getData = async () => {
        const d = await getUserData("userData")
...
//             />
//           </View>
//           {/* <Text style={styles.profileDeatilsTitle}>{Profiletext(email)}</Text> */}
...
//             />
//           </View>
//           {/* <Text style={styles.profileDeatilsTitle}> {Profiletext(Gender)}</Text> */}
//         </View>
//         <View style={styles.profileDeatils}>
//           <View style={styles.imgCon}>
//             <Image
...
//           </View>
//           {/* <Text style={styles.profileDeatilsTitle}> {Profiletext(address)}  </Text> */}
//         </View>
