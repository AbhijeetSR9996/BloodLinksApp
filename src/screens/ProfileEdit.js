...
const ProfileEdit = ({navigation, route}) => {
  ...
  const saveData = () => {
    ...
    setblood_group(userData.blood_group);
  ...
  const ProfileEdit1 = async () => {
    ...
    fetch(url, {
      ...
      .then(Response => Response.json())
      .then(Response => {
        // console.log('RESPONSE Profile Edit api-------------->>>>', Response);
  ...
  // const ProfileEdit1 = async () => {
  //   const res = await fetch('https://bloodlinks.in/myprofile_edit', {
  //     method: 'POST',
  //     headers: {
  //       Accept: 'application/json',
  //       'Content-Type': 'application/json',
