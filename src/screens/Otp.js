...
const Otp = ({route}) => {
  ...
  // SmsRetriever.startSmsRetriever(event => {
  ...
  const OtpVerify = () => {
    ...
    fetch(url, {
      ...
      .then(Response => {
        ...
        console.log(
          'RESPONSE apiiii otp verfiy ---------OTP----->>>>',
        ...
        if (Response.status == true) {
          ...
          //storeUserData("userData", Response.data)
          console.log(Response, 'otp screen');
          // Response.data.map(item => {
          //   storeUserData('userrId', item.user_id);
          //   storeUserData('fname', item.first_name);
          //   storeUserData('lname', item.last_name);
          //   storeUserData('email', item.email);
          //   storeUserData('ph_no', item.ph_no);
          //   storeUserData('age', item.age);
          //   storeUserData('gender', item.gender);
          //   storeUserData('blood_group', item.blood_group);
          //   storeUserData('address', item.address);
          // });
        } else {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.inputview}>
        ...
        {/* <OTPInputView
          ...
          pinCount={4}
          code={pin1} //You can supply this prop or not. The component will be used as a controlled / uncontrolled component respectively.
          // onCodeChanged = {code =>  setpin1(code.toString().split('/'))}
          codeInputFieldStyle={{color:'black',fontSize:scale(14),fontWeight:'500'}}
          autoFocusOnLoad
          onCodeFilled={(code) => {
            setpin1(code)
