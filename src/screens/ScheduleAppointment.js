...
//   console.log(form_id,"form id in appoinment screen")
  ...
  const Confirm = () => {
    ...
    if(date1!=null)
    {
      ...
      alert("Please first select the appointment date")
    }
    ...
    <View
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Text
            style={{fontSize: scale(16), textAlign: 'center', color: 'white'}}>
            Book
          </Text>
        </TouchableOpacity>
      </View>
      ...
      <Modal animationType="fade" transparent={true} visible={modalVisible}>
        <View
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() => Confirm()}
              //1onPress={()=>{handleConfirm==true?Confirm():''}}
              style={{
                height: moderateScale(40),
                width: '50%',
                flexDirection: 'column',
  ...
  return (
    <View style={{flex: 1, alignItems: 'center', flexDirection: 'column'}}>
      <DrawerHeader name={'Blood Centre'} image1={false} />
      <ScrollView style={{flex: 1}}>
        <View
          ...
          <Text style={{fontSize: 20}}>Select Blood Centre</Text>
          <View
            style={{
              flexDirection: 'column',
          ...
          <View
            ...
            <View
              ...
              <TouchableOpacity
                onPress={() => navigation.navigate('AppointmentReset')}
                style={{
                  height: moderateScale(40),
                  width: '45%',
                  flexDirection: 'column',
