...
const SecondForm = ({route,}) => {
  ...
  const YourSexPartner5C = value => {
    if (value == 'yes') {
      ...
      setModalVisible(true);
      settextString(
        'Thinks any of the above questions may be true for your sex partner',
      );
    }
  };
  ...
  const secondFormApi = async () => {
    ...
    // console.log('form id =', route.params.form_id);

    let url = `https://bloodlinks.in/donation_Appointment`; //API to
    // console.log('hello Women', WomenId);
    // navigation.navigate('ThirdForm'); //{remove kar na hai}
    var headers = {
    ...
    fetch(url, {
      ...
      .then(Response => {
        // console.log('RESPONSE of second form ', Response);
        // console.log(' second Id-------------->>>>', WomenId)
        if (Response.status == true) {
          // alert('Second Form successfully submit !')
          // console.log(Response.form_id, 'form id from 2');
  ...
  return (
    <View
      ...
      <View
        ...
        <Text style={{fontSize: scale(18), color: 'white'}}>Step 2</Text>
      </View>
        ...
        <View
          ...
          <View
            ...
            <View
              ...
              <Text style={{fontSize: scale(14), color: 'black'}}>
                2. Are You HIV Positive Or Do You Think You May Be HIV Positive?
              </Text>
              <View
                style={{
                  height: moderateScale(55),
            ...
            <View
              ...
              <Text style={{fontSize: scale(15), color: 'black'}}>
                3. Is Your Reason For Donating Blood To Undergo An HIV Test ?
              </Text>
              <View
                style={{
                  height: moderateScale(55),
            ...
            <View
              ...
              <Text style={{fontSize: scale(14), color: 'black'}}>
                A) Have You Had Sexual Activity By Paying Money Or Vise Versa ?
              </Text>
              <View
                style={{
                  height: moderateScale(55),
            ...
            <View
              ...
              <Text style={{fontSize: scale(14), color: 'black'}}>
                B) Have You Had Multiple Sex Partners ?
              </Text>
              <View
                style={{
                  height: moderateScale(55),
            ...
            <View
              ...
              <Text style={{fontSize: scale(14), color: 'black'}}>
                D) Sex With Someone Whose Background You Do Not Know ?
              </Text>
              <View
                style={{
                  height: moderateScale(55),
            ...
            <View
              ...
              <Text style={{fontSize: scale(14), color: 'black'}}>
                A) Have You Suffered From Sexually Transmitted Disease ?
              </Text>
              <View
                style={{
                  height: moderateScale(55),
            ...
            <View
              ...
              <Text style={{fontSize: scale(14), color: 'black'}}>
                B) Have You Ever Injected Yourself With Drugs Not Prescribed By
                Doctor ?
              </Text>
              <View
                style={{
            ...
            <View
              ...
              <Text style={{fontSize: scale(14), color: 'black'}}>
                C) Do You Think Any Of The Above Questions May Be True For Your
                Sex Partner ?
              </Text>
              <View
                style={{
                ...
                <RadioButton
                  ...
                  status={checkedC1 === 'no' ? 'checked' : 'unchecked'}
            ...
            <View
              ...
              <Text style={{fontSize: scale(14), color: 'black'}}>
                D) Do You Consider Your Blood Safe For Transfusion To A Patient
                ?
              </Text>
              <View
                style={{
            ...
            <View
              ...
              <Text style={{fontSize: scale(16), color: 'black'}}>
                1) The test done on your donated Blood are follows :
              </Text>
              <Text style={{fontSize: scale(13), color: 'grey'}}>1) HBsAg</Text>
            ...
            <View
              ...
              <Text style={{fontSize: scale(14), color: 'black',}}>
                2) These tests are also done free of cost at ICTC Centre. If you
                are looking to get the test done, please contact Department of
                Microbiology,SMS Medical College. Jaipur.
              </Text>
              <Text style={{fontSize: scale(14), color: 'black', marginTop: '5%'}}>
                3) All the test results are kept highly confidential.
              </Text>
              <Text
                style={{
                  fontSize: scale(14),
                ...
                4) 𝐃𝐚𝐧𝐠𝐞𝐫 : the window period,laboratory tests are negative but
                the person is still capable of infecting others. Help keep the
                blood supply as safe as possible by looking HONESTLY at your
                lifestyle & answering the question truthfully.
              </Text>
            </View>
          </View>
        </View>
