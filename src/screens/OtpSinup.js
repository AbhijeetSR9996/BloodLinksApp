...
const shyam =  route.params.deta;

console.log("otp date of birth =----------------" , shyam.dob)
// --------------------------------------------------------

    const datafetched = route.params;
    console.log('data from signup',datafetched.deta);
    //setFetchdata(deta);
