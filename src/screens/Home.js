...
const HOME = ({route, props}) => {
  ...
  const data = [{pic: image.Page1}, {pic: image.Page2}, {pic: image.Page3}];
  const data1 = [{pic: image.Page1}, {pic: image.Page2}];
      ...
      <View style={styles.homeHeader}>
        <View style={styles.homeSearchHeader}>
          <TouchableOpacity
            ...
            <Image style={styles.heardingMenuImg} source={image.menu} />
          </TouchableOpacity>
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {/* <View >
          <TouchableOpacity onPress={()=>{navigation.navigate('Profile',{msg:'Aman'})}}>
