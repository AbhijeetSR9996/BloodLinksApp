    ...
    <View style={styles.Drawerstyle}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Pressable
          ...
          />
          <View>
            <Text style={{ color: 'white', width: scale(140), fontSize: scale(14), fontWeight: '500', textAlign: 'left' }}>{'Donation History'}</Text>
          </View>
        </Pressable>
        <Pressable
          onPress={() => {
          ...
          />
          <View>
            <Text style={{ color: 'white', width: scale(140), fontSize: scale(14), fontWeight: '500', textAlign: 'left' }}>{'Requests History'}</Text>
          </View>
        </Pressable>
